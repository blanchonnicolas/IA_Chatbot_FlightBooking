...
class StrDateResolverDialog(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(StrDateResolverDialog, self).__init__(
            dialog_id or StrDateResolverDialog.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, StrDateResolverDialog.datetime_prompt_validator
        )
    ...
    async def initial_step(
        ...
        prompt_msg = "On what date would you like to leave ?"
        reprompt_msg = (
            "I'm sorry, for best results, please enter your departure "
            "date including the month, day and year., e.g. December 6 2022"
        )
