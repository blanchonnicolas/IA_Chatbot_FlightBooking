...
if __name__ == "__main__":
    ...
    luis_testing = Luis_Testing()

    authoringKey, authoringEndpoint, predictionKey, predictionEndpoint, luisappId = get_local_file_secrets()

    #--------------- AUTHORING ---------------
    luis_testing.authentify(authoringKey, authoringEndpoint)
    luis_testing.get_app_version(luisappId)
    # luis_testing.clone_app_version(luisappId)
    # luis_testing.create_FlyMe_app()
    # luis_testing.create_FlyMe_intent()
    # luis_testing.create_FlyMe_prebuilt_entity()
    # for entity in ["From", "To", "budget", "str_date", "end_date"]:
    #     modelId_Entity = luis_testing.create_FlyMe_ml_entity(entity)  
    
    # #--------------- TRAINING ---------------
    # luis_testing.batch_training_with_labeled_utterances()
    # luis_testing.training_status()
    # luis_testing.publish_app()

    # #--------------- TESTING ---------------
    valid_json_file = luis_testing.load_json(None, "valid.json")
    operation_id = luis_testing.batch_testing_with_labeld_utterances(valid_json_file)
    luis_testing.batch_testing_status(operation_id)
    luis_testing.batch_testing_results()
